...
import 'package:selective/screen/dashboard/dashboard_page_controller.dart';
...
class yetklili_home extends StatefulWidget {
  const yetklili_home({super.key});

  @override
  State<yetklili_home> createState() => _yetklili_homeState();
}

class _yetklili_homeState extends State<yetklili_home> {
  int loading = 0;
  var yetki = 0;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children:  [
            InkWell( 
              onTap: () {
               Navigator.push(context, MaterialPageRoute(builder: (context) => dash_page_controller()));
              },
              child: CircleAvatar(
                backgroundColor: Color.fromARGB(255, 171, 197, 225),
                radius: 20,
                        ...
                        return Container(
                          ...
                          child: DataTable(
                            ...
                            columns: [
                              ...
                              DataColumn(
                                  label: Text('Öncelik Durumu Ve Atanan')),
                              DataColumn(label: Text('Durum')),
                              DataColumn(label: Text('Kategori')),
                              DataColumn(label: Text('Konu Başlığı')),
      ...
      floatingActionButton: yetki == 1 || yetki == 0
          ? FloatingActionButton(
              backgroundColor: const Color.fromARGB(255, 171, 197, 225),
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
  ...
  Future secenekSayfa0yetki23(String Postid) {
                ...
                ? ListTile(
                    ...
                    title: TextButton(
                        onPressed: () {
                          ...
                          durum = "Selective Talebi Reddetti";
                          iptalpost(Postid, durum, 3);
                          notifpush().dataget(Postid, 1, durum);
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: const [
            ...
            actions: [
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      durum = "Firmanın Servis Ücret Onayı Bekleniyor";
