...
class wait_yetkili extends StatefulWidget {
  const wait_yetkili({super.key});

  @override
  State<wait_yetkili> createState() => _wait_yetkiliState();
}

class _wait_yetkiliState extends State<wait_yetkili> {
  int loading = 0;
  var yetki = 0;
                ...
                title: TextButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                CommentsScreen(postId: postid.toString()),
                          ));
                    },
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
