...
class wait_post_screen extends StatefulWidget {
  const wait_post_screen({super.key});

  @override
  State<wait_post_screen> createState() => _wait_post_screenState();
}

class _wait_post_screenState extends State<wait_post_screen> {
  int loading = 1;
  var yetki = 0;
  var firma;
