...
class iptal_screen extends StatefulWidget {
  const iptal_screen({super.key});

  @override
  State<iptal_screen> createState() => _iptal_screenState();
}

class _iptal_screenState extends State<iptal_screen> {
  int loading = 0;
  var yetki = 0;
