...
class succes_post_screen extends StatefulWidget {
  const succes_post_screen({super.key});

  @override
  State<succes_post_screen> createState() => _succes_post_screenState();
}

class _succes_post_screenState extends State<succes_post_screen> {
  int loading = 1;
  var yetki = 0;
  var firma;
